...
vcom -93 -work work $GT_SRC/packages/gtl_pkg.vhd
vcom -93 -work work $GT_SRC/data/gtl/sub_eta.vhd

#Testbench
vcom -93 -work work $TESTBENCH/sub_eta_test_tb.vhd

#Load Design
vsim -t 1ps work.sub_eta_test_tb 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/sub_eta_test_wave.do
