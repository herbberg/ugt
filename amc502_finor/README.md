### Build amc502_finor firmware with IPBB ###
...
* These branches contain modified MP7 files for amc502_finor (files are taken from directory "replacement_files"):
...
### Setup using script ###
    ...
    python amc502_finor/scripts/runIpbbSynth.py <vivado version [2018.2]> -t <MP7 tag [mp7fw_v2_4_1]> -p <work dir> -m <menu path> --ugt <ugt master, branch or tag name> -b <build version>
